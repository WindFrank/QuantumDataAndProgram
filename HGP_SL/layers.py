...
from HGP_SL.sparse_softmax import Sparsemax
...
class NodeInformationScore(MessagePassing):
    ...
    def norm(edge_index, num_nodes, edge_weight, dtype=None):
        ...
        edge_index, edge_weight = add_remaining_self_loops(edge_index, edge_weight, 0.1, num_nodes)
...
class HGPSLPool(torch.nn.Module):
    ...
    def forward(self, x, edge_index, edge_attr, batch=None):
        ...
        if self.sample:
            ...
            new_edge_index, new_edge_attr = add_remaining_self_loops(new_edge_index, new_edge_attr, 0.1, x.size(0))
